...
class Model(nn.Module):
    ...
    def run_batch(self, batch: Batch, max_output_length: int, beam_size: int,
        ...
        if beam_size < 2:
            ...
            # sy_debug: added n_best_scores in return
            stacked_output, n_best_score, stacked_attention_scores = \
                    beam_search(
                        ...
                        decoder=self.decoder,n_best=50)

        return stacked_output, n_best_score, stacked_attention_scores
